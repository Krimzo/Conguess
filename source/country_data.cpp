...
//{
//    read_country_data( "data/countries.txt" );
//
//    if ( const std::string boundaries_file = "textures/earth_boundaries.png"; !std::filesystem::exists( boundaries_file ) )
//    {
//        generate_boundary_map( boundaries_file );
//    }
//
//    if ( const std::string indices_file = "textures/earth_indices.png"; !std::filesystem::exists( indices_file ) )
//    {
